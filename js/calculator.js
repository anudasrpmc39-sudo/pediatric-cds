...
function calculate(){
  ...
  // SAFE AGE READ (won't break app if missing)
  let ageInput = document.getElementById("age");
  let ageUnitInput = document.getElementById("ageUnit");

  let age = ageInput ? parseFloat(ageInput.value) : null;
  let ageUnit = ageUnitInput ? ageUnitInput.value : "months";

  if(ageUnit === "years" && age){
    age = age * 12;
  }
...
// VERY IMPORTANT → ensures dropdown loads
